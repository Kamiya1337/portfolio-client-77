        ...
        <div className="reflection-grid">
          ...
          <article className="reflection-paper blue">
            ...
            <p>
              ...
              <br /><br />
              Đối với kỹ năng tìm kiếm và đánh giá thông tin, em sẽ duy trì thói quen sử dụng các nguồn tài liệu học thuật uy tín, đồng thời rèn luyện khả năng phân tích và kiểm chứng thông tin trước khi sử dụng. Điều này sẽ giúp em nâng cao chất lượng học tập và tránh tiếp nhận những thông tin thiếu chính xác. Về việc sử dụng trí tuệ nhân tạo, em dự định tiếp tục học cách xây dựng Prompt hiệu quả hơn để khai thác tối đa lợi ích của AI trong học tập và nghiên cứu. Tuy nhiên, em sẽ luôn tuân thủ các nguyên tắc về liêm chính học thuật, sử dụng AI như một công cụ hỗ trợ thay vì thay thế hoàn toàn tư duy và sự sáng tạo của bản thân. Là sinh viên ngành Biên phiên dịch tiếng Anh, em cũng sẽ ứng dụng những kỹ năng đã học vào việc tra cứu tài liệu song ngữ, sử dụng các công cụ hỗ trợ dịch thuật và nâng cao khả năng làm việc trực tuyến. Đồng thời, em sẽ tích cực rèn luyện kỹ năng giao tiếp, hợp tác và quản lý thời gian để chuẩn bị tốt hơn cho môi trường làm việc chuyên nghiệp trong tương lai. Thông qua kế hoạch này, em mong muốn không ngừng hoàn thiện năng lực số, nâng cao khả năng tự học và thích nghi với những thay đổi của công nghệ, từ đó tạo nền tảng vững chắc cho quá trình học tập cũng như định hướng nghề nghiệp sau này.
            </p>
          </article>
        </div>
